...
def get_object_folders():	
	...
	with connection.cursor() as cursor:
        ...
        where a.element_id =173 and b.table_num = 57 and a.value_longtext1 is not null and date_format(from_unixtime(c.log_datetime),'%Y%m%d') > DATE(NOW() - INTERVAL 15 DAY) 
		"""
...
while i <size:
	if str(series[i]) != '1802-04':
		...
		prefix = "http://archives.seattle.gov/digital-collections/index.php/Search/objects/search/ca_objects.type_id%3A25+AND+ca_collections.idno%3A+%22"
